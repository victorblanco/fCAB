 ...
 */
    ...
    protected function getUrls( $file ){
		...
		$this->compile_dir = $entornos[0]."/".tpl_pre;
		
		foreach( $entornos as $entorno){
			if (is_file($entorno."/".tpl_dir.$file)){
				$this->template_dir = $entorno."/".tpl_dir; 
			}
		}
   ...
   /**
    ...
    {
    	$itt_file = $this->_get_itt_filename($this->compile_dir, $resource_name, $this->_compile_id);
		
    	if (App::isITT() || @filemtime($itt_file) >= @filemtime($compile_path)){
    		return false;
    	}
   ...
   /**
    ...
    function _get_auto_filename($auto_base, $auto_source = null, $auto_id = null)
    {
        ...
        if(isset($auto_source)) {
        	...
        	$_return .= "$itt$auto_source"."_".App::getLocale().".php";
   ...
   /**
     ...
     * @staticvar string|null
     */
    function _get_itt_filename($auto_base, $auto_source = null, $auto_id = null)
    {
        $_compile_dir_sep =  $this->use_sub_dirs ? DIRECTORY_SEPARATOR : '^';
        $_return = $auto_base . DIRECTORY_SEPARATOR;
