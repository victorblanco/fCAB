...
if (!defined('RELATIVE_PATH')) define('RELATIVE_PATH','core/pdf/');
if (!defined('FPDF_FONTPATH')) define('FPDF_FONTPATH','core/pdf/font/');
class FPDF
{
...
function _parsepng($file)
{
	...
	elseif($ct==3)
		...
		Log::add('Alpha channel not supported: '.$file);
